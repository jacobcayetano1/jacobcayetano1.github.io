function clearAll()
{
	/*
  let container;
  let contentListNames = {};
  $("div[class$'_"+class+"']").each(function() {
    contentListNames[this.class] = this.class;
  })

	for(const i = 0; i < contentList.length(); i++)
	{
		container = document.querySelector(contentList[i]);
		container.innerHTML = '';
	}
  */
...
function showRiddle()
{
  ...
  riddleAnswer.setAttribute('id', 'riddle_answer');
